...
nyc_calls$borough <- borough 
borough_csv <- write.csv(nyc_calls$borough, file="311_boroughs.csv")
table(nyc_calls$borough) 
nyc_calls$borough[nyc_calls$borough == "Bronx County"] <- "Bronx"

nyc_calls$borough <- replace(nyc_calls$borough, nyc_calls$borough == 'Bronx County' | nyc_calls$borough == 'New York City Housing Authority Pelham Community Housing' | nyc_calls$borough == 'The Bronx', "Bronx") # replacing weird values for Bronx 

nyc_calls$borough <- replace(nyc_calls$borough, nyc_calls$borough == 'Queens County', "Queens") # replacing weird values for Queens 
