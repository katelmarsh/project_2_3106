...
recommend_resume <- function(file_path = file_path, n_recommendations = n_recommendations){
  ...
  recommended_result = head(recommended_result[order(recommended_result[,"diversity_metric"]),], n_recommendations) 
...
hist(as.numeric(result1[,"diversity_metric"]))
par(new = TRUE)
hist(as.numeric(result2[,"diversity_metric"]))
par(new = TRUE)
hist(as.numeric(result3[,"diversity_metric"]))
