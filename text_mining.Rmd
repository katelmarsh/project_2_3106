...
```
For each job description(each row in the tf_ids_1), I get the top 5 tokens with the highest tf-idf value. We can also extract the top 5 tokens with highest tf-idf scores in our resume, and see if there will be some tokens overlapping between the job description and the resume.
